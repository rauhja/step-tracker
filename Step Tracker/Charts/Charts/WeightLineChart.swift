...
struct WeightLineChart: View {
    ...
    var body: some View {
        let config = ChartContainerConfiguration(title: "Weight", symbol: "figure", subtitle: "Avg: \(averageWeight.formatted(.number.precision(.fractionLength(1)))) lbs", context: .weight, isNav: true)
